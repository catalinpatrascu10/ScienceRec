...
public class Signup extends JFrame implements ActionListener{
	...
	JLabel lblUsername = new JLabel("NomUtilisateur :");
	...
	JLabel lblPassword = new JLabel("MotPasse :");
	lblPassword.setForeground(Color.DARK_GRAY);
	lblPassword.setFont(new Font("Tahoma", Font.BOLD, 14));
	lblPassword.setBounds(99, 160, 92, 26);
	contentPane.add(lblPassword);

	JLabel lblAnswer = new JLabel("Reponse :");
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Votre NickName?", "Votre Lucky Number?",
			"Votre SuperHero?", "Votre childhood Name ?" }));
	comboBox.setBounds(265, 202, 148, 20);
	contentPane.add(comboBox);

	JLabel lblSecurityQuestion = new JLabel("Questions securite :");
