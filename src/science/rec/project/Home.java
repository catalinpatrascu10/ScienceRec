...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            menuBar.setBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(0, 128, 0), new Color(95,158,160)));
            menuBar.setBackground(Color.CYAN);
            menuBar.setBounds(0, 10, 1000, 35);
            contentPane.add(menuBar);

            JMenu mnExit = new JMenu("Fermer");
            mnExit.setFont(new Font("Trebuchet MS", Font.BOLD, 17));
            
            
            JMenuItem mntmLogout = new JMenuItem("Se Deconecter");
            mntmLogout.setBackground(new Color(211, 211, 211));
            mntmLogout.setForeground(new Color(105, 105, 105));
            mntmLogout.addActionListener(this);
            mnExit.add(mntmLogout);
            
            JMenuItem mntmExit = new JMenuItem("Fermer");
            ...
            JLabel l1 = new JLabel("ScienceRecProject");
            ...
            b1 = new JButton("Ajouter Materiaux");
            ...
            panel.setBorder(new TitledBorder(new LineBorder(new Color(250, 128, 114), 2), "PartieADMINISTRATUER", TitledBorder.LEADING,
				TitledBorder.TOP, null, new Color(220, 20, 60)));
            panel.setBounds(20, 120, 750, 260);
            panel.setBackground(Color.WHITE);
            contentPane.add(panel);

            b4 = new JButton("Voir Materiaux");
            ...
            b5 = new JButton("Retourner Materiaux");
            ...
            panel2.setBorder(new TitledBorder(new LineBorder(new Color(205, 133, 63), 2), "PartieETUDIANT", TitledBorder.LEADING,
